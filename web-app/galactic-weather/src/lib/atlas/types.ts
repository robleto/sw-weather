...
/**
 * Which kind of text the world's art can carry. In the landed view the readout
 * sits directly on the planet photo — no scrim, no text-shadow — so this is a
 * property of the image, not of `primary`. Generated by
 * scripts/measure-text-tone.py; do not hand-edit.
 */
...
export interface World {
	...
	climate: Climate;
	color: WorldColor;
	/** Generated — see TextTone. */
	textTone: TextTone;
	/** The concrete color to draw text in over this world's art. Generated. */
	textColor: string;
	/**
...
export interface ResolvedWorld {
	...
	description: string;
	color: WorldColor;
	/** Which kind of text this world's art can carry. */
	textTone: TextTone;
	/** The color to draw text in over this world's art. */
	textColor: string;
